...
Eone_e_C <- function(yA, tA) {
    .Call(`_CRFutil2_Eone_e_C`, yA, tA)
}
...
#' @param wAB  omega matrix
#'
Etwo_e_C <- function(yA, yB, wAB) {
    .Call(`_CRFutil2_Etwo_e_C`, yA, yB, wAB)
}
...
#' @param wAB  omega matrix
#'
config_energy_e_C <- function(config, edges_mat, one_nlp, two_nlp) {
    .Call(`_CRFutil2_config_energy_e_C`, config, edges_mat, one_nlp, two_nlp)
}
